...
func main() {
	...
	library.members["Filipe"] = Member{"Filipe", make(map[Title]LendAudit)}
	library.members["Sara"] = Member{"Sara", make(map[Title]LendAudit)}
	library.members["Alice"] = Member{"Alice", make(map[Title]LendAudit)}

	fmt.Println("\nInitial:")
	printLibraryBooks(&library)
	printMemberAudits(&library)

	member := library.members["Filipe"]
